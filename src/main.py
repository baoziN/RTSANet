...
from models import RTSANet
from util import llprint, multi_label_metric, ddi_rate_score, get_n_params

torch.manual_seed(1203)

model_name = 'RTSANet'
resume_name = 'saved/RTSANet'
...
def main():
    ...
    model = RTSANet(voc_size, ehr_adj, ddi_adj, ddi_mask_H, emb_dim=args.dim, device=device, ddi_in_memory=args.ddi)
